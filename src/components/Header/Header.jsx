					...
					<div className="row header-row ">
						...
						<div className="col-sm-7 part3 ">
							<div className="menu-part menu-last ">
								...
								<button
									className="open-btn cart-icon-top "
								...
								{/**** mail box  ******/}
								<button className="open-btn " onClick={handleOpenMail}>
									{" "}
									<IoMdMail />
									<div className="topper-box">
										<span> 5 </span>
											...
											<div className="single-item-noti my-2">
												...
												<div className="not-info">
													<h4>
														...
														<span>
															{" "}
															<b>Goutam ray </b> added to his favorite list{" "}
								...
								{openDrop === true && (
									<ul className="dropdown-menu-item shadow">
										...
										<li>
											...
											>
												{" "}
												<PiShieldWarningFill /> reset password{" "}
											</Link>
										</li>
										<li>
											<Link
