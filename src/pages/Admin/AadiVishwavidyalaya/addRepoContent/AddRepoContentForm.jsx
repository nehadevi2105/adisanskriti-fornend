	...
	return (
		<Box sx={{ width: "100%", maxWidth: 600, mx: "auto", mt: 4 }}>
			...
			<form onSubmit={handleSubmit(handleFormSubmit)}>
				...
				>
					<InputLabel id="tribe-label">Tribe</InputLabel>
					<Controller
						name="tribe"
						control={control}
				...
				<div style={{ marginTop: "20px" }}>
					<label className="block text-sm font-medium mb-2">Repo Details</label>
					<JoditEditor
						value={htmlContent}
						config={editorConfig}
			...
			<Button onClick={testSnackbar} variant="text" sx={{ mt: 1 }}>
				Test Snackbar
			</Button>
